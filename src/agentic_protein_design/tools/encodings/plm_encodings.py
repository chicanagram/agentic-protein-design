...
import numpy as np
from agentic_protein_design.tools.encodings.common import _sanitize_name, compute_pooled_embeddings, save_layerwise_embeddings
...
def _load_plm_module(plm_name: str):
    ...
    module_name = f"agentic_protein_design.tools.encodings.{plm_name}"
