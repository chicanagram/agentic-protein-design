...
def build_tools_registry(repo_root: Path) -> Dict[str, Any]:
    ...
    scan_roots = [
        ...
        repo_root / "src/agentic_protein_design/tools",
    ]
    skip_prefixes = [
        repo_root / "src/agentic_protein_design/tools/pythia/pythia",
        repo_root / "src/agentic_protein_design/tools/__pycache__",
    ...
    return {
        ...
        "generated_from": [
            ...
            "src/agentic_protein_design/tools",
        ],
...
def main() -> None:
    """CLI entrypoint for generating src/agentic_protein_design/tools/config/tools_registry.first_pass.json."""
    repo_root = Path(__file__).resolve().parents[4]
    registry = build_tools_registry(repo_root)
    out_path = repo_root / "src/agentic_protein_design/tools/config/tools_registry.first_pass.json"
