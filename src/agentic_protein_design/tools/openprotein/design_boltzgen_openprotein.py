...
from agentic_protein_design.tools.openprotein.openprotein_utils import connect_openprotein_session
from agentic_protein_design.tools.utils.struct_utils import align_structures, convert_cif_to_pdb_pymol
...
def run_proteinmpnn_postdesign_pipeline(
    ...
    *,
    ...
    from agentic_protein_design.tools.openprotein.predict_boltz2_structure_openprotein import predict_boltz2
